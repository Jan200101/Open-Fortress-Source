...
uint g_aWeaponDamageTypes[] =
{
	...
	DMG_DISSOLVE,																				// TF_WEAPON_GRAVITY_GAUNTLETS
	DMG_BUCKSHOT | DMG_USEDISTANCEMOD,															// TF_WEAPON_LEVER_ACTION
	DMG_SLASH,																					// TF_WEAPON_LEAD_PIPE
	DMG_IGNITE | DMG_PREVENT_PHYSICS_FORCE | DMG_PREVENT_PHYSICS_FORCE,							// TF_WEAPON_FLAMETHROWER_PYRO,
	...
	DMG_IGNITE | DMG_PREVENT_PHYSICS_FORCE | DMG_PREVENT_PHYSICS_FORCE,							// TFC_WEAPON_FLAMETHROWER,
