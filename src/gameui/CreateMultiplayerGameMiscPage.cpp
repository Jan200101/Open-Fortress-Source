...
#define DEFAULT_OPTIONS_FILE OPTIONS_DIR "/setting_misc_default.scr"
#define OPTIONS_FILE OPTIONS_DIR "/setting_misc.scr"
//-----------------------------------------------------------------------------
// Purpose: class for loading/saving server config file
//-----------------------------------------------------------------------------
class CMiscServerDescription : public CDescription
{
public:
	CMiscServerDescription(CPanelListPanel *panel);
...
// Constructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameMiscPage::CCreateMultiplayerGameMiscPage(vgui::Panel *parent, const char *name) : PropertyPage(parent, name)
{
	SetScheme("SwarmScheme");

	m_pOptionsList = new CPanelListPanel(this, "MiscOptions");

	m_pDescription = new CMiscServerDescription(m_pOptionsList);
	m_pDescription->InitFromFile(DEFAULT_OPTIONS_FILE);
	m_pDescription->InitFromFile(OPTIONS_FILE);
	m_pList = NULL;

	LoadControlSettings("Resource/CreateMultiplayerGameMiscPage.res");
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameMiscPage::~CCreateMultiplayerGameMiscPage()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CCreateMultiplayerGameMiscPage::GetValue(const char *cvarName, const char *defaultValue)
{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameMiscPage::OnApplyChanges()
{
	...
	if (m_pDescription)
	{
		...
		g_pFullFileSystem->CreateDirHierarchy(OPTIONS_DIR, "MISC");
		fp = g_pFullFileSystem->Open(OPTIONS_FILE, "wb", "MISC");
		if (fp)
		{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameMiscPage::LoadGameOptionsList()
{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameMiscPage::GatherCurrentValues()
{
	if (!m_pDescription)
		return;
...
//-----------------------------------------------------------------------------
CMiscServerDescription::CMiscServerDescription(CPanelListPanel *panel) : CDescription(panel)
{
	...
	setDescription("SERVER_MISC_OPTIONS");
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CMiscServerDescription::WriteScriptHeader(FileHandle_t fp)
{
	char am_pm[] = "AM";
	...
	g_pFullFileSystem->FPrintf(fp, "DESCRIPTION SERVER_MISC_OPTIONS\r\n{\r\n");
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CMiscServerDescription::WriteFileHeader(FileHandle_t fp)
{
	char am_pm[] = "AM";
