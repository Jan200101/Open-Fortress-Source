...
#define DEFAULT_OPTIONS_FILE OPTIONS_DIR "/setting_movement_default.scr"
#define OPTIONS_FILE OPTIONS_DIR "/setting_movement.scr"
//-----------------------------------------------------------------------------
// Purpose: class for loading/saving server config file
//-----------------------------------------------------------------------------
class CMovementServerDescription : public CDescription
{
public:
	CMovementServerDescription(CPanelListPanel *panel);
...
// Constructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameMovementPage::CCreateMultiplayerGameMovementPage(vgui::Panel *parent, const char *name) : PropertyPage(parent, name)
{
	SetScheme("SwarmScheme");

	m_pOptionsList = new CPanelListPanel(this, "MovementOptions");

	m_pDescription = new CMovementServerDescription(m_pOptionsList);
	m_pDescription->InitFromFile(DEFAULT_OPTIONS_FILE);
	m_pDescription->InitFromFile(OPTIONS_FILE);
	m_pList = NULL;

	LoadControlSettings("Resource/CreateMultiplayerGameMovementPage.res");
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameMovementPage::~CCreateMultiplayerGameMovementPage()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CCreateMultiplayerGameMovementPage::GetValue(const char *cvarName, const char *defaultValue)
{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameMovementPage::OnApplyChanges()
{
	...
	if (m_pDescription)
	{
		...
		g_pFullFileSystem->CreateDirHierarchy(OPTIONS_DIR, "MOVEMENT");
		fp = g_pFullFileSystem->Open(OPTIONS_FILE, "wb", "MOVEMENT");
		if (fp)
		{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameMovementPage::LoadGameOptionsList()
{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameMovementPage::GatherCurrentValues()
{
	if (!m_pDescription)
		return;
...
//-----------------------------------------------------------------------------
CMovementServerDescription::CMovementServerDescription(CPanelListPanel *panel) : CDescription(panel)
{
	...
	setDescription("SERVER_MOVEMENT_OPTIONS");
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CMovementServerDescription::WriteScriptHeader(FileHandle_t fp)
{
	char am_pm[] = "AM";
	...
	g_pFullFileSystem->FPrintf(fp, "DESCRIPTION SERVER_MOVEMENT_OPTIONS\r\n{\r\n");
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CMovementServerDescription::WriteFileHeader(FileHandle_t fp)
{
	char am_pm[] = "AM";
