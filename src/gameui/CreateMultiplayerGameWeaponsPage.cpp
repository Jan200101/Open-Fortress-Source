...
#define DEFAULT_OPTIONS_FILE OPTIONS_DIR "/setting_weapons_default.scr"
#define OPTIONS_FILE OPTIONS_DIR "/setting_weapons.scr"
//-----------------------------------------------------------------------------
// Purpose: class for loading/saving server config file
//-----------------------------------------------------------------------------
class CWeaponsServerDescription : public CDescription
{
public:
	CWeaponsServerDescription(CPanelListPanel *panel);
...
// Constructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameWeaponsPage::CCreateMultiplayerGameWeaponsPage(vgui::Panel *parent, const char *name) : PropertyPage(parent, name)
{
	SetScheme("SwarmScheme");

	m_pOptionsList = new CPanelListPanel(this, "WeaponsOptions");

	m_pDescription = new CWeaponsServerDescription(m_pOptionsList);
	m_pDescription->InitFromFile(DEFAULT_OPTIONS_FILE);
	m_pDescription->InitFromFile(OPTIONS_FILE);
	m_pList = NULL;

	LoadControlSettings("Resource/CreateMultiplayerGameWeaponsPage.res");
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameWeaponsPage::~CCreateMultiplayerGameWeaponsPage()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CCreateMultiplayerGameWeaponsPage::GetValue(const char *cvarName, const char *defaultValue)
{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameWeaponsPage::OnApplyChanges()
{
	...
	if (m_pDescription)
	{
		...
		g_pFullFileSystem->CreateDirHierarchy(OPTIONS_DIR, "WEAPONS");
		fp = g_pFullFileSystem->Open(OPTIONS_FILE, "wb", "WEAPONS");
		if (fp)
		{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameWeaponsPage::LoadGameOptionsList()
{
...
//-----------------------------------------------------------------------------
void CCreateMultiplayerGameWeaponsPage::GatherCurrentValues()
{
	if (!m_pDescription)
		return;
...
//-----------------------------------------------------------------------------
CWeaponsServerDescription::CWeaponsServerDescription(CPanelListPanel *panel) : CDescription(panel)
{
	...
	setDescription("SERVER_WEAPONS_OPTIONS");
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponsServerDescription::WriteScriptHeader(FileHandle_t fp)
{
	char am_pm[] = "AM";
	...
	g_pFullFileSystem->FPrintf(fp, "DESCRIPTION SERVER_WEAPONS_OPTIONS\r\n{\r\n");
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponsServerDescription::WriteFileHeader(FileHandle_t fp)
{
	char am_pm[] = "AM";
