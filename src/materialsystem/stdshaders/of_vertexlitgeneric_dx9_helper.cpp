...
#include "of_vertexlit_and_unlit_generic_vs30.inc"
#include "of_vertexlit_and_unlit_generic_ps30.inc"
#include "of_vertexlit_and_unlit_generic_bump_vs30.inc"
#include "of_vertexlit_and_unlit_generic_bump_ps30.inc"
#include "of_vertexlit_and_unlit_generic_vs20.inc"
#include "of_vertexlit_and_unlit_generic_ps20b.inc"
#include "of_vertexlit_and_unlit_generic_bump_vs20.inc"
#include "of_vertexlit_and_unlit_generic_bump_ps20b.inc"

#include "commandbuilder.h"
#include "convar.h"

ConVarRef	my_mat_fullbright("mat_fullbright");
...
static ConVarRef mat_luxels( "mat_luxels" );
...
/*^*/ // 		printf("\t\t      -> CShaderShadowDX8::VertexShaderVertexFormat( flags=%08x, texcount=%d )\n",flags,nTexCoordCount);
			...
			if ( bHasBump || bHasDiffuseWarp )
			{
				if (g_pHardwareConfig->SupportsShaderModel_3_0())
				{
					...
					DECLARE_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_bump_vs30);
					...
					SET_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_bump_vs30);

					DECLARE_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_bump_ps30);
					...
					SET_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_bump_ps30);
				}
				else
				{
					{
						...
						DECLARE_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_bump_vs20);
						SET_STATIC_VERTEX_SHADER_COMBO(HALFLAMBERT, bHalfLambert);
						...
						SET_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_bump_vs20);


						DECLARE_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_bump_ps20b);
						SET_STATIC_PIXEL_SHADER_COMBO(CUBEMAP, bHasEnvmap);
						SET_STATIC_PIXEL_SHADER_COMBO(DIFFUSELIGHTING, hasDiffuseLighting);
						SET_STATIC_PIXEL_SHADER_COMBO(LIGHTWARPTEXTURE, bHasDiffuseWarp && !bHasSelfIllumFresnel);
						SET_STATIC_PIXEL_SHADER_COMBO(SELFILLUM, bHasSelfIllum);
						...
						SET_STATIC_PIXEL_SHADER_COMBO(FLASHLIGHTDEPTHFILTERMODE, nShadowFilterMode);
						SET_STATIC_PIXEL_SHADER_COMBO(BLENDTINTBYBASEALPHA, bBlendTintByBaseAlpha);
						SET_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_bump_ps20b);
					}
				}
			}
			else // !(bHasBump || bHasDiffuseWarp)
			{
				...
				if (g_pHardwareConfig->SupportsShaderModel_3_0())
				{
					...
					DECLARE_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_vs30);
					...
					SET_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_vs30);

					DECLARE_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_ps30);
					...
					SET_STATIC_PIXEL_SHADER_COMBO( BLENDTINTBYBASEALPHA, bBlendTintByBaseAlpha );
					SET_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_ps30);
				} 
				else
				{
					bool bUseStaticControlFlow = g_pHardwareConfig->SupportsStaticControlFlow();

					DECLARE_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_vs20);
					SET_STATIC_VERTEX_SHADER_COMBO(VERTEXCOLOR, bHasVertexColor || bHasVertexAlpha);
					SET_STATIC_VERTEX_SHADER_COMBO(CUBEMAP, bHasEnvmap);
					SET_STATIC_VERTEX_SHADER_COMBO(HALFLAMBERT, bHalfLambert);
					SET_STATIC_VERTEX_SHADER_COMBO(FLASHLIGHT, bHasFlashlight);
					...
					SET_STATIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_vs20);

					DECLARE_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_ps20b);
					SET_STATIC_PIXEL_SHADER_COMBO(SELFILLUM_ENVMAPMASK_ALPHA, (hasSelfIllumInEnvMapMask && (bHasEnvmapMask)));
					SET_STATIC_PIXEL_SHADER_COMBO(CUBEMAP, bHasEnvmap);
					SET_STATIC_PIXEL_SHADER_COMBO(CUBEMAP_SPHERE_LEGACY, bHasLegacyEnvSphereMap);
					SET_STATIC_PIXEL_SHADER_COMBO(DIFFUSELIGHTING, hasDiffuseLighting);
					...
					SET_STATIC_PIXEL_SHADER_COMBO(BLENDTINTBYBASEALPHA, bBlendTintByBaseAlpha);
					SET_STATIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_ps20b);
				}
			}
	...
	if ( pShaderAPI )
	{
		...
		if ( bHasBump || bHasDiffuseWarp )
		{
			if (g_pHardwareConfig->SupportsShaderModel_3_0())
			{
				...
				SET_DYNAMIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_bump_vs30);

				DECLARE_DYNAMIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_bump_ps30);
				SET_DYNAMIC_PIXEL_SHADER_COMBO( NUM_LIGHTS, lightState.m_nNumLights );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( AMBIENT_LIGHT, lightState.m_bAmbientLight ? 1 : 0 );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( FLASHLIGHTSHADOWS, bFlashlightShadows );
//				SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
				SET_DYNAMIC_PIXEL_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_bump_ps30);
			...
			else
			{
				...
				DECLARE_DYNAMIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_bump_vs20);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(DOWATERFOG, fogIndex);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(SKINNING, numBones > 0);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(COMPRESSED_VERTS, (int)vertexCompression);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(NUM_LIGHTS, bUseStaticControlFlow ? 0 : lightState.m_nNumLights);
				SET_DYNAMIC_VERTEX_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_bump_vs20);

				
				DECLARE_DYNAMIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_bump_ps20b);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(NUM_LIGHTS, lightState.m_nNumLights);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(AMBIENT_LIGHT, lightState.m_bAmbientLight ? 1 : 0);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(FLASHLIGHTSHADOWS, bFlashlightShadows);
				SET_DYNAMIC_PIXEL_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_bump_ps20b);
			}
		}
		else // !( bHasBump || bHasDiffuseWarp )
		{
			...
			if (g_pHardwareConfig->SupportsShaderModel_3_0())
			{
				...
				SET_DYNAMIC_VERTEX_SHADER_COMBO( MORPHING, pShaderAPI->IsHWMorphingEnabled() );
				SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
				SET_DYNAMIC_VERTEX_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_vs30);

				DECLARE_DYNAMIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_ps30);
//				SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( FLASHLIGHTSHADOWS, bFlashlightShadows );
				...
				SET_DYNAMIC_PIXEL_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_ps30);
			...
			else
			{
				...
				DECLARE_DYNAMIC_VERTEX_SHADER(of_vertexlit_and_unlit_generic_vs20);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(DYNAMIC_LIGHT, lightState.HasDynamicLight());
				SET_DYNAMIC_VERTEX_SHADER_COMBO(STATIC_LIGHT_VERTEX, lightState.m_bStaticLightVertex ? 1 : 0);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(STATIC_LIGHT_LIGHTMAP, lightState.m_bStaticLightTexel ? 1 : 0);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(DOWATERFOG, fogIndex);
				...
				SET_DYNAMIC_VERTEX_SHADER_COMBO(COMPRESSED_VERTS, (int)vertexCompression);
				SET_DYNAMIC_VERTEX_SHADER_COMBO(NUM_LIGHTS, bUseStaticControlFlow ? 0 : lightState.m_nNumLights);
				SET_DYNAMIC_VERTEX_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_vs20);

				DECLARE_DYNAMIC_PIXEL_SHADER(of_vertexlit_and_unlit_generic_ps20b);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(FLASHLIGHTSHADOWS, bFlashlightShadows);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(STATIC_LIGHT_LIGHTMAP, lightState.m_bStaticLightTexel ? 1 : 0);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(DEBUG_LUXELS, bHasMatLuxel ? 1 : 0);
				SET_DYNAMIC_PIXEL_SHADER_COMBO(
					LIGHTING_PREVIEW,
					pShaderAPI->GetIntRenderingParameter(INT_RENDERPARM_ENABLE_FIXED_LIGHTING));
				SET_DYNAMIC_PIXEL_SHADER_CMD(DynamicCmdsOut, of_vertexlit_and_unlit_generic_ps20b);
			}
		}
